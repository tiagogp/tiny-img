...
export const THEME_STORAGE_KEY = "tinyimg:theme:v1";
 ...
 *  is kept to one statement of work: read the choice, resolve "system" — the
 *  absent case — against the OS, and set the attribute the palette keys off.
 *
